...
class GameViewController: GLKViewController {
    ...
    func setupGL() {
        ...
        glEnableVertexAttribArray(GLuint(GLKVertexAttrib.Position.toRaw()))
        // Not working...
        //glVertexAttribPointer(GLuint(GLKVertexAttrib.Position.toRaw()), 3, GL_FLOAT, GL_FALSE, 24, BUFFER_OFFSET(0))
        glEnableVertexAttribArray(GLuint(GLKVertexAttrib.Normal.toRaw()))
        // Not working...
    ...
    func loadShaders() -> Bool {
        ...
        glBindAttribLocation(program, GLuint(GLKVertexAttrib.Position.toRaw()), "position")
        glBindAttribLocation(program, GLuint(GLKVertexAttrib.Normal.toRaw()), "normal")
